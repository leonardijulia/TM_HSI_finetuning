...
from src.datamodules.enmap_bnetd import EnMAPBNETDDataModule
...
def plot_sample(image, label, num_classes, save_path, prediction=None, suptitle=None, class_names=None, show_axes=False):
    ...
    "#134606",  # Dense forest
    "#95dd64",  # Light forest
    "#70cbce",  # Forest gallery
    "#4669c9",  # Forest plantation
    "#7c580b",  # Cocoa plantation
    "#c171c4",  # Rubber plantation
    "#f0e87e",  # Cashew plantation
    "#ff9100",  # Agricultural area
    "#c5b28e",  # Tree savannah
    "#d62728",  # Human habitat
...
def main():
    ckpt_path = "./outputs/enmap_bnetd/checkpoints/last.ckpt"
    data_root = "./data/enmap_bnetd"
    out_dir = "./outputs/enmap_bnetd/inference_results"
    ...
    class_names = ["Dense forest", "Light forest", "Forest Gallery", "Forest plantation",
                   "Cocoa plantation", "Rubber plantation", "Cashew plantation",
                   "Agricultural area", "Tree savannah", "Human habitat", "Background"]
